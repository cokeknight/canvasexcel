...
import {_gl_mouseState,
   ...
   glGetMouseScreenXY, glGetEvent  ,glGetTarget,glCaptureDoumentEvent,glCancelDoumentEvent
  } from './glMouseEvent'
function Window(config) {
  ...
  this.sysmousedown = function(e) {
    this.mousedownuniqueId = this.uniqueId
    glSetMouseState(true);
    glSetMouseFocusWin(this)
    glCaptureDoumentEvent(this)
    let i,
      compos,
      mousepos
  ...
  this.glGetMouseState= function() {
      return _gl_mouseState.mousedownstate;
  }
  this.sysmousemove = function(e) {
    if (!this.mousedownuniqueId) return false
    let i,
      compos,
      mousepos
...
Window.prototype.unionId = 1
Window.prototype.getUniqueId = function(){
  if (this.__proto__.unionId) {
    this.__proto__.unionId +=1
    return this.__proto__.unionId
  }
}
